  ...
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-stretch md:grid-cols-3 md:gap-8">
      ...
      <div className="p-6 sm:px-8">
        ...
        <ul className="mt-2 space-y-2 sm:mt-4">
          <li className="flex items-center gap-1">
            ...
            <span className="text-gray-700">Create 5 Free Mock Interviews </span>
          </li>
          ...
          <li className="flex items-center gap-1">
            ...
            <span className="text-gray-700"> 10 Retake Interviews </span>
          </li>
    ...
    <div className="divide-y divide-gray-200 rounded-2xl border border-gray-200 shadow-xs">
      <div className="p-6 sm:px-8">
        ...
        <a
          className="mt-4 block rounded-sm border border-indigo-600 bg-indigo-600 px-12 py-3 text-center text-sm font-medium text-white hover:bg-transparent hover:text-indigo-600 focus:ring-3 focus:outline-hidden sm:mt-6"
          href="https://buy.stripe.com/test_dRmfZg9Anh1paUV2FbdUY03"
        >
          Get Started
        </a>
      </div>
      ...
      <div className="p-6 sm:px-8">
        ...
        <ul className="mt-2 space-y-2 sm:mt-4">
          <li className="flex items-center gap-1">
            ...
            <span className="text-gray-700">Create 20 Free Mock Interviews Per Day </span>
          </li>
          ...
          <li className="flex items-center gap-1">
            ...
            <span className="text-gray-700"> 50 Retake Interviews Per Day </span>
          </li>
    ...
    <div className="divide-y divide-gray-200 rounded-2xl border border-gray-200 shadow-xs">
      <div className="p-6 sm:px-8">
        ...
        <a
          className="mt-4 block rounded-sm border border-indigo-600 bg-indigo-600 px-12 py-3 text-center text-sm font-medium text-white hover:bg-transparent hover:text-indigo-600 focus:ring-3 focus:outline-hidden sm:mt-6"
          href="https://buy.stripe.com/test_3cI3cu4g3fXl1klfrXdUY02"
        >
          Get Started
        </a>
      </div>
      ...
      <div className="p-6 sm:px-8">
        ...
        <ul className="mt-2 space-y-2 sm:mt-4">
          <li className="flex items-center gap-1">
            ...
            <span className="text-gray-700">Create Unlimited Mock Interviews </span>
          </li>
          ...
          <li className="flex items-center gap-1">
            ...
            <span className="text-gray-700"> Unlimited Retake Interviews </span>
          </li>
